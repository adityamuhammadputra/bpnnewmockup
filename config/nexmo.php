...
return [
    ...
    */
    ...
    'api_key'    => function_exists('env') ? env('NEXMO_KEY', '9fb4a15b') : '',
    'api_secret' => function_exists('env') ? env('NEXMO_SECRET', 'NGXUKwA6T6JxTIVi') : '',
    ...
    |--------------------------------------------------------------------------
    |
    | If you're using a signature secret, use this section. This can be 
