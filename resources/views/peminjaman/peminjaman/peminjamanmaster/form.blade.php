<div id="form-peminjamanmaster">
    <form method="post" data-toogle="validator" class="form-horzontal" id="form">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select name="ruang" id="ruang" class="form-control">
                        ...
                        <option value="Manual Rack">Manual Rack</option>
                        <option value="Kardex 1">Kardex 1</option>
                        <option value="Kardex 2">Kardex 2</option>
                    </select>
                    <span class="help-block with-errors"></span>
                </div>        
            </div>
            <div class="col-md-2">
                <div class="form-group">
                    <label for="name" class="control-label">Status BT</label>
                    <select name="status_pinjam" id="status" class="form-control" readonly>
                        <option value="0">BT Tersedia</option>
                        <option value="1" selected>BT Tidak Tersedia</option>
                    </select>
                    <span class="help-block with-errors"></span>
                </div>        
            </div>  
            <div class="col-md-2">
                <div class="form-group">
                    <label for="name" class="control-label">Status SU</label>
                    <select name="status_pinjam2" id="status2" class="form-control" readonly>
                        <option value="0">SU Tersedia</option>
                        <option value="1" selected>SU Tidak Tersedia</option>
                    </select>
                    <span class="help-block with-errors"></span>
                </div>        
            </div>        
