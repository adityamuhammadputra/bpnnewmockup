...
@push('scripts')
    <script>
        ...
        function editForm(id) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#status').val(data.status_pinjam);
                    $('#status2').val(data.status_pinjam2);
                },
                error: function () {
        ...
        function deleteData(id) {
          ...
          $(document).on('click', '#cekpinjam2', function(){
            var id = $(this).data('id');
            var status_pinjam2 = $(this).data('value');

            $.ajax({
                url: "{{ url('peminjamanmastercekpijam2') }}",
                type:"GET",
                data:{status_pinjam2:status_pinjam2, id:id},
                success:function(data){
                    $('#data-master').dataTable().api().ajax.reload();
                    $('div.flash-message').html(data);
                },
